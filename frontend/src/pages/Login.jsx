  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center relative overflow-hidden py-10 px-4">
      ...
      >
        ...
        <div className="w-full md:w-1/2 bg-[#3B82F6] flex flex-col justify-center items-center p-8 relative overflow-hidden min-h-[320px] md:min-h-auto select-none border-b md:border-b-0 md:border-r border-white/5 z-10">
          ...
          {/* Static Image (no translation or hover parallax shifts) */}
          <div className="w-full h-full flex justify-center items-center relative z-10">
            <img 
              src={loginBanner} 
              alt="Online Auction Illustration" 
              className="w-full h-full object-contain max-h-[280px] md:max-h-none pointer-events-none drop-shadow-[0_15px_30px_rgba(0,0,0,0.3)]"
            />
          </div>
        </div>
